            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="section-title center">
                        ...
                        <p><em>Inscribete ahora a alguno de los cursos que tenemos preparados para ti diligenciando el siguiente <strong>formulario de inscripcion</strong>.</em></p>  
                        <p><em>no debes dejar ninguna casilla en blanco puesto que nuestro sistema valida que los datos solicitados se encuentren diligenciados en su totalidad, Bienvenido.</em></p>          
                    </div>
